...
set yrange [0:pi*n_output_timesteps/(n_timesteps*dt*normfreq)]
set xrange [-1.496351666698318:1.496351666698318]
set cbrange [1e-4:1e4]
set samples nx

plot "run0_1d3v/disp_E1_x.dat" matrix using (($1-nx/2)*2*pi/dx/nx/normk/n_lineout_raumschritte):($2*2*pi/dt/normfreq/n_timesteps):($3*n_lineout_raumschritte*n_lineout_raumschritte) with image notitle \

...
E1 = `sed -n -e 4p thermal_equib1_1/energy.dat | awk '{print $2}'`
E3 = `sed -n -e 4p thermal_equib1_3/energy.dat | awk '{print $2}'`
E5 = `sed -n -e 4p thermal_equib1_5/energy.dat | awk '{print $2}'`
E10 = `sed -n -e 4p thermal_equib1_10/energy.dat | awk '{print $2}'`
E30 = `sed -n -e 4p thermal_equib1_30/energy.dat | awk '{print $2}'`
E100 = `sed -n -e 4p thermal_equib1_100/energy.dat | awk '{print $2}'`
E300 = `sed -n -e 4p thermal_equib1_300/energy.dat | awk '{print $2}'`
E1000 = `sed -n -e 4p thermal_equib1_1000/energy.dat | awk '{print $2}'`

set title "nppc = 50"
set output "E_50.png"
plot "thermal_equib1_1/energy.dat"    u 1:($2/E1-1.)    w l t "Xi 1"   \
,    "thermal_equib1_3/energy.dat"    u 1:($2/E3-1.)    w l t "Xi 3"   \
,    "thermal_equib1_5/energy.dat"    u 1:($2/E5-1.)    w l t "Xi 5"   \
,    "thermal_equib1_10/energy.dat"   u 1:($2/E10-1.)   w l t "Xi 10"  \
,    "thermal_equib1_30/energy.dat"   u 1:($2/E30-1.)   w l t "Xi 30"  \
,    "thermal_equib1_100/energy.dat"  u 1:($2/E100-1.)  w l t "Xi 100" \
,    "thermal_equib1_300/energy.dat"  u 1:($2/E300-1.)  w l t "Xi 300" \
,    "thermal_equib1_1000/energy.dat" u 1:($2/E1000-1.) w l t "Xi 1000"
